...
"")
        ...
        self.modelButton = QtWidgets.QPushButton(self.groupBox_8)
        self.modelButton.setMinimumSize(QtCore.QSize(40, 28))
...
"background-color: rgba(48,148,243,80);}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/img/icon/数据探索.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.modelButton.setIcon(icon4)
...
"")
        ...
        self.comboBox_2.setMinimumSize(QtCore.QSize(85, 28))
...
"background-color: rgba(48,148,243,80);}")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/img/icon/打开.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fileButton.setIcon(icon5)
        self.fileButton.setObjectName("fileButton")
        self.horizontalLayout_8.addWidget(self.fileButton)
        self.imagefileButton = QtWidgets.QPushButton(self.groupBox_5)
        self.imagefileButton.setMinimumSize(QtCore.QSize(55, 28))
        self.imagefileButton.setMaximumSize(QtCore.QSize(16777215, 28))
        ...
        self.imagefileButton.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(-1)
        font.setBold(True)
        font.setWeight(75)
        self.imagefileButton.setFont(font)
        self.imagefileButton.setStyleSheet("QPushButton{font-family: \"Microsoft YaHei\";\n"
"font-size: 14px;\n"
"font-weight: bold;\n"
"color:white;\n"
"text-align: center center;\n"
...
"border-radius: 0px;\n"
"background-color: rgba(48,148,243,80);}")
        self.imagefileButton.setText("")
        self.imagefileButton.setIcon(icon5)
        self.imagefileButton.setObjectName("imagefileButton")
        self.horizontalLayout_8.addWidget(self.imagefileButton)
...
"background-color: rgba(48,148,243,80);}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/img/icon/摄像头开.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cameraButton.setIcon(icon6)
...
"background-color: rgba(48,148,243,80);}")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/img/icon/实时视频流解析.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rtspButton.setIcon(icon7)
...
"")
        ...
        self.savefileButton = QtWidgets.QPushButton(self.groupBox_6)
        self.savefileButton.setMinimumSize(QtCore.QSize(43, 28))
        self.savefileButton.setMaximumSize(QtCore.QSize(16777215, 28))
        self.savefileButton.setStyleSheet("QPushButton{font-family: \"Microsoft YaHei\";\n"
"font-size: 14px;\n"
"font-weight: bold;\n"
"color:white;\n"
"text-align: center center;\n"
...
"background-color: rgba(48,148,243,80);}")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/img/icon/doctor.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.savefileButton.setIcon(icon8)
        self.savefileButton.setObjectName("savefileButton")
        self.horizontalLayout_36.addWidget(self.savefileButton)
        self.pushButton = QtWidgets.QPushButton(self.groupBox_6)
        self.pushButton.setMinimumSize(QtCore.QSize(43, 28))
...
"background-color: rgba(48,148,243,80);}")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/img/icon/evil.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"background-color: rgba(223, 223, 223, 150);}")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/img/icon/运行.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon10.addPixmap(QtGui.QPixmap(":/img/icon/暂停.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon10.addPixmap(QtGui.QPixmap(":/img/icon/运行.png"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        icon10.addPixmap(QtGui.QPixmap(":/img/icon/暂停.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        icon10.addPixmap(QtGui.QPixmap(":/img/icon/运行.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon10.addPixmap(QtGui.QPixmap(":/img/icon/暂停.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon10.addPixmap(QtGui.QPixmap(":/img/icon/运行.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        icon10.addPixmap(QtGui.QPixmap(":/img/icon/暂停.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
        self.runButton.setIcon(icon10)
...
"background-color: rgba(223, 223, 223, 150);}")
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/img/icon/终止.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
